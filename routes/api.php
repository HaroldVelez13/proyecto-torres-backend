...
Route::group(['middleware' => ['auth:api']], function (){
	...
	Route::prefix('tools')->group(function(){
		...
		Route::get('getForCategory/{id}',	'Api\ApiToolController@index');	  
	...
	Route::prefix('checkins')->group(function(){
		Route::get('/',						'Api\ApiCheckinController@index');
		Route::get('/{id}',					'Api\ApiCheckinController@show');	  
		Route::post('/create',				'Api\ApiCheckinController@create');
		Route::put('/{id}/update',			'Api\ApiCheckinController@update');
		Route::put('/{id}/addTool',			'Api\ApiCheckinController@addTool');
		Route::put('/{id}/leastTool',		'Api\ApiCheckinController@leastTool');
		Route::delete('/{id}/delete',	    'Api\ApiCheckinController@delete');
